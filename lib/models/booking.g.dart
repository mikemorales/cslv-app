...
Booking _$BookingFromJson(Map<String, dynamic> json) => Booking(
  ...
  totalAmount: _asCurrencyFromCents(json['total_amount']),
  specialRequests: _asNullableString(json['special_requests']),
  status: _asString(json['status']),
  paymentRule: _asString(json['payment_rule']),
  depositAmount: _asNullableCurrencyFromCents(json['deposit_amount']),
  balanceAmount: _asNullableCurrencyFromCents(json['balance_amount']),
